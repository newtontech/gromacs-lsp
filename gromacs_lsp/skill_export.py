...
SKILL_SPEC_JSON = (
    '{"schema":"scientific-lsp-skill/v1","name":"gromacs","software":"gromacs","d'
    'isplay_name":"GROMACS","description":"GROMACS input preflight for .mdp, topo'
    'logy, and generated run packages.","package":{"name":"gromacs-lsp","install"'
    ':"pip install gromacs-lsp"},"entrypoints":{"server":"gromacs-lsp","tool":"gr'
    'omacs-lsp-tool"},"file_patterns":["*.top","*.itp","*.mdp","*.gro"],"operatio'
    'ns":["capabilities","check","context","complete","hover","symbols","fix"],"d'
    'iagnostic_contract":"DiagnosticEnvelope/v1","blocking_policy":{"mode":"fail-'
    'on-blocking","description":"Use --fail-on-blocking when generated inputs mus'
    't be launch-ready."},"source_provenance":[{"kind":"official_docs","label":"G'
    'ROMACS documentation","url":"https://manual.gromacs.org/current/"}]}'
)
...
SKILL_MD_LINES = [
    ...
    'name: gromacs',
    (
        'description: "GROMACS input preflight for .mdp, topology, and generated run '
        'packages."'
    ),
    '---',
    '',
    ...
    '',
    (
        'Use this skill when preparing, repairing, or reviewing GROMACS input files b'
        'efore a run. It provides an installable language server and an agent-facing '
    ...
    '',
    (
        'This installs the `gromacs-lsp` language server and the `gromacs-lsp-tool` a'
        'gent CLI from the `gromacs-lsp` Python package.'
    ),
    '',
    ...
    (
        'gromacs-lsp-tool context <input-file-or-dir> --line 0 --character 0 --format'
        ' json'
    ),
    (
        'gromacs-lsp-tool hover <input-file-or-dir> --line 0 --character 0 --format j'
        'son'
    ),
    (
        'gromacs-lsp-tool complete <input-file-or-dir> --line 0 --character 0 --forma'
        't json'
    ),
    'gromacs-lsp-tool symbols <input-file-or-dir> --format json',
    (
        'gromacs-lsp-tool fix <input-file-or-dir> --line 0 --character 0 --format jso'
        'n'
    ),
    '```',
    '',
