...
```bash
gromacs-lsp-tool check path/to/input --format json
gromacs-lsp-tool context path/to/input --format json
gromacs-lsp-tool complete path/to/input --format json
gromacs-lsp-tool hover path/to/input --format json
gromacs-lsp-tool symbols path/to/input --format json
gromacs-lsp-tool fix path/to/input --format json
```
